        ...
        <div class="container-fluid">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="media align-items-center mb-4">
                                <div class="media-body">
                                    <h3 class="mb-0">{{ $supervisor->name }}</h3>
                                    <p class="text-muted mb-0">lecture</p>
                                </div>
                            </div>
                            <h4>Terms Of Service</h4>
                            <p class="text-muted">{{ $supervisor->supervisorprofile->comment }}</p>
                            <ul class="card-profile__info">
                                <li><strong class="text-dark mr-4">Email</strong> <span>{{ $supervisor->email }}</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8 col-xl-9">
                            ...
                            <div class="media media-reply">
                                <div class="media-body">
                                    <div class="d-sm-flex justify-content-between mb-2">
                                        <h5 class="mb-sm-0">Welcome Note <small class="text-muted ml-3">{{ date('y-m h:ia', strtotime($supervisor->created_at)) }}</small></h5>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('supervisor.comment.store') }}" method='POST' class="form-profile">
                                @csrf
