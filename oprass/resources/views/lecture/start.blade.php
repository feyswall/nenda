            ...
            <div class="row">
                <div class="col-lg-4 col-xl-3">
                    <div class="card">
                        ...
                        <p class="text-muted">{{ $lecture->profile->comment }}</p>
                        <ul class="card-profile__info">
                            <li><strong class="text-dark mr-4">Email</strong> <span>{{ $lecture->email }}</span></li>
                        </ul>
                    </div>
                </div>
                </div>
                <div class="col-lg-8 col-xl-9">
                            ...
                            <div class="media media-reply">
                                <div class="media-body">
                                    <div class="d-sm-flex justify-content-between mb-2">
                                        <h5 class="mb-sm-0">Welcome Note <small class="text-muted ml-3">{{ date('y-m h:ia', strtotime($lecture->created_at)) }}</small></h5>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('lecture.comment.store') }}" method='POST' class="form-profile">
                                @csrf
