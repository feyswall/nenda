                                ...
                                <table class="table table-striped table-bordered zero-configuration">
                                    ...
                                    @foreach( $profiles as $profile )
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn mb-1 btn-outline-primary btn-sm" href="{{ route('assistance_lecture.show', $profile->lect_assistance_id )}}">View</a>
                                            </td>
                                            <td>
                                                <form action="{{ route('assistance_lecture.destroy', $profile->lect_assistance_id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
