                                ...
                                <table class="table table-striped table-bordered zero-configuration">
                                    ...
                                    @foreach( $profiles as $profile )
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn mb-1 btn-outline-primary btn-sm" href="{{ route('tutorial_assistance.show', $profile->tut_assistance_id )}}">View</a>
                                            </td>
                                            <td>
                                                <form action="{{ route('tutorial_assistance.destroy', $profile->tut_assistance_id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
