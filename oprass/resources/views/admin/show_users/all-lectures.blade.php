                                ...
                                <table class="table table-striped table-bordered zero-configuration">
                                    ...
                                    @foreach( $profiles as $profile )
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn mb-1 btn-outline-primary btn-sm" href="{{ route('lecture.show', $profile->lecture_id )}}">View</a>
                                            </td>
                                            <td>
                                                <form action="{{ route('lecture.destroy', $profile->lecture_id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
