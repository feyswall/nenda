...
class CreateAssistanceLectureProfilesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('assistance_lecture_profiles', function (Blueprint $table) {
            ...
            $table->index('lect_assistance_id');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('assistance_lecture_profiles');
    }
}
